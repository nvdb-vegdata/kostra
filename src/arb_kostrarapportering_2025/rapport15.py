...
def main():
    ...
    tunnel_df = tunnel_df[tunnel_df['lengde'] >= 500]

    tunnel_df.to_excel("src/arb_kostrarapportering_2025/test_rapport15.xlsx")
    lengde, antall = tell_antall_og_lengde_per_fylke(tunnel_df)
    ...
    del f['ider']
    rapportgenerator(resultat_df, f, "Kostra 15 - Fylkesveg tunnel lengde enn 500m", "Fv tunnel over 500m")
