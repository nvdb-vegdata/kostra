...
def main():
    ...
    tunnel_df.to_excel("src/arb_kostrarapportering_2025/test_rapport16.xlsx")
    ...
    del f['ider']
    rapportgenerator(resultat_df, f, "Kostra 16 - Fylkesveg tunnel høyde under 4m", "Fv tunnel under 4m")
