...
def main():
    ...
    #f['egenskap'] = 'egenskap(10901)=18186 OR egenskap(10901)=18187 OR egenskap(10901)=18188 OR egenskap(10901)=18189 OR egenskap(10901)=18190'
    f['egenskap'] = '10901>18185'
    f['inkluder'] = 'lokasjon'
    f['sideanlegg'] = 'false'
    ...
    obj_df.to_excel("src/arb_kostrarapportering_2025/test_rapport5.xlsx")
    ...
    rapportgenerator(lengde_df, f, "Kostra 05 - Fylkesveg aksellast u 10t", "Fv aksellast u 10t")
